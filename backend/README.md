...
## Project Structure
    ...
    ├── real_estate_app_tem_37747  # Django project configurations
...
1. Clone this repo and `cd real_estate_app_tem_37747`
...
2. Clone this repo and `cd real_estate_app_tem_37747`
